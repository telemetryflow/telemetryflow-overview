...
| `POST`   | `/api/v2/sso/providers`        | Create SSO provider config |
| `GET`    | `/api/v2/sso/providers`        | List SSO providers         |
| `GET`    | `/api/v2/sso/providers/:id`    | Get provider details       |
| `PATCH`  | `/api/v2/sso/providers/:id`    | Update provider config     |
